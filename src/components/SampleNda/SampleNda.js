...
const createRenderers = ({ ndaTemplate }) => {
  ...
  const InlineCode = (props) => (
    <BoldText>
      {
        ndaTemplate.data.blanks[props.value].placeholder
        || capitalizeWords(humps.decamelize(props.value, { separator: ' ' }))
      }
    </BoldText>
  );
...
const SampleNda = ({ user, ndaTemplate }) => {
