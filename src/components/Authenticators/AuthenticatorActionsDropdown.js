...
const AuthenticatorActionsDropdown = ({ authenticator, onDeregisterClick }) => (
  <ReachMenu>
    {(/* { isExpanded } */) => (
      <>
        <MoreOptionsButton id="authenticator-more-options">
          <MoreIcon aria-hidden />
        </MoreOptionsButton>
        <MoreOptionsMenuList>
          <ReachMenuItem onSelect={() => onDeregisterClick(authenticator)}>
            <FormattedMessage
              id="authenticator-actions-dropdown-deregister-authenticator"
              defaultMessage="Deregister Authenticator"
            />
          </ReachMenuItem>
        </MoreOptionsMenuList>
      </>
...
export default AuthenticatorActionsDropdown;
